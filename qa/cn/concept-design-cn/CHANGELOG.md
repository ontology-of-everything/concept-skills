# concept-design-cn Changelog

## 0.8.2 - 2026-09-22

- 和用户一起完成概念设计：先确认对齐三节，再写设计记录。
- 资格判据保留概念定义，以及教程原文八项与类、特性、用户故事、微服务区分的决策依据。
- 压缩重复说明，并写明内在/外在依赖、收紧/放松和三对招法。
...
- Default off: run only on explicit `$concept-design-cn` / `/concept-design-cn`.
...
- Rename the installable skill from `jackson-concept-design-cn` to
  `concept-design-cn`; the concept-* family now shares one prefix with
...
- Initial Jackson concept-design-cn skill for turning requirements into concepts
