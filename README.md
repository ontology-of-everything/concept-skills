...
| [`concept-implementation`](docs/skills/en/concept-implementation.md) | [`concept-implementation-cn`](docs/skills/cn/concept-implementation-cn.md) | Implements independent concepts and named synchronization rules.             |
